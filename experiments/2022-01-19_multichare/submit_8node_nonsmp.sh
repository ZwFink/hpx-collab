...
python3 $HOME/hpx-collab/scripts/run.py --basedir $BASEDIR --ntasks 1000 --iter $((1<<6)) $((1<<27)) 8 --output_file "$2" --width $width --steps 1000 --type stencil_1d --trials 3 --run_args "+pemap L0-47"
