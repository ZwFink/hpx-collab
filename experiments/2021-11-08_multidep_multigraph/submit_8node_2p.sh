...
python3 $HOME/hpx-collab/scripts/run.py --basedir $BASEDIR --ntasks 1000 --iter $((1<<6)) $((1<<27)) 8 --output_file "$1" --width $width --steps 1000 --run_args "+setcpuaffinity" --type spread --trials 3 --output "$output" --ngraphs 4 --radix 5 --run_args "++ppn 23" --run_args "+commap L0,24" --run_args "+pemap L1-23,25-47"
