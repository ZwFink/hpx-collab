...
echo "This script is used to run local hpx (join executor) task bench 1 buran nodes, width 48 fixed width, from 2(6) to 2(24) spread pattern, 5 deps/task "
date
...
do
		...
		srun new_hpx_local -type spread -radix 5   -width 48 -steps 1000 -kernel compute_bound -iter ${it} --hpx:threads=48
