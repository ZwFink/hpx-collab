...
echo "This script is used to run distributed MPI bulk_synchronous task bench 1 buran nodes, width 96 fixed width, from 2(6) to 2(24) spread pattern, 5 dependeces/task"
date
...
do
        ...
        do
                ...
                srun  bulk_synchronous -type spread -radix 5  -width 96 -steps 1000 -kernel compute_bound -iter ${it}
