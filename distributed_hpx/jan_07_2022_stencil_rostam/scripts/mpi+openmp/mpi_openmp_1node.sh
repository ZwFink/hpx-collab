...
echo "This script is used to run distributed MPI+OpenMP task bench 1 buran nodes, width 48 fixed width, from 2(6) to 2(24) "
date
...
do
	...
	do
        	...
        	srun  forall -type stencil_1d  -width 48 -steps 1000 -kernel compute_bound -iter ${it} 
        	echo "done iter =====================================  "
